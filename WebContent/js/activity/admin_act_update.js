...
function act_update() {
    if (act_id !== null) {
        ...
        xmlHttp.send('act_id='+act_id[1]+'&act_title=' + act_title + '&act_content=' + act_content + '&act_startTime=' + act_startTime + '&act_endTime=' + act_endTime + '&act_enrollment=' + act_enrollment + '&action=1');
