...
function submit() {
    ...
    xmlHttp.send('UserName=' + username + '&Account=' + account + '&PassWord=' + password + '&Confirm_Password=' + conpsw + "&Gender=" + gender_val + '&Tel=' + tel + '&QQ=' + qq + '&Email=' + ema + '&Academy=' + academy + "&CheckCode=" + checkcode);
