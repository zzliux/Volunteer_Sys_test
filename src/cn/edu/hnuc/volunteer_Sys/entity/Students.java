...
public class Students {
    ...
    public String toString() {
        return "Students [stu_id=" + stu_id + ", stu_account=" + stu_account + ", stu_pwd=" + stu_pwd + ", stu_name=" + stu_name + ", stu_sex=" + stu_sex + ", stu_phone=" + stu_phone + ", stu_qq=" + stu_qq + ", academy_id=" + academy_id + ", academy_info=" + academy_info + ", stu_email=" + stu_email + ", actList=" + actList + "]";
    }
}
