...
public class info_Update {
    // 增加活动
    public static boolean addAct(String act_title, String act_content, Date act_startTime, Date act_endTime, int academy_id, int act_enrollment) {
        // 求出活动状态
    ...
    public static boolean updateAct(int act_id, String act_title, String act_content, Date act_startTime, Date act_endTime, int academy_id, int act_enrollment) {
        int aca_id;
        int act_status;
        try {
            // 创办该活动的学院id
    ...
    public static int updateActstatus(Date act_startTime, Date act_endTime) {
        ...
        if (act_startTime.getTime() > nowTime) {
            act_status = 0;
        } else if (act_startTime.getTime() <= nowTime && nowTime <= act_endTime.getTime()) {
            act_status = 1;
        } else {
            act_status = 2;
        }
    ...
    // 学生信息的修改
    public static boolean updateStu(int id, String stu_account, String stu_pwd, String stu_name, String stu_sex, String stu_phone, String stu_qq, String stu_email, int academy_id) {
        try {
            // 学生所属学院
